...
type PbArticle = {
  ...
  category?: string;
  expand?: {
    category?: { slug?: string; name_vi?: string; name_jp?: string; name?: string };
  };
};

export default function AuthorPage() {
  const params = useParams<{ lang: string; name: string }>();
            ...
            <CardContent className="p-8">
              <div className="flex flex-col md:flex-row items-center gap-8">
                ...
                <div className="text-center md:text-left flex-1">
                  <h1 className="text-3xl font-serif font-bold text-foreground mb-2">{authorDisplayName}</h1>
                  {author.role && (
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="divide-y divide-dotted divide-border">
            {articlesLoading ? (
              ...
              articles.map((article) => <CategoryArticleItem key={article.id} article={article} />)
            ) : (
          ...
          {totalPages > 1 && (
            <CategoryPagination currentPage={currentPage} totalPages={totalPages} onPageChange={handlePageChange} />
          )}
        </div>
      </main>
      <Footer />
